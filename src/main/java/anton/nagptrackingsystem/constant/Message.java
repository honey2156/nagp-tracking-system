...
public class Message {
	...
	public static String BATCH_INVALID_START_DATE = "Start date year must be same as batch year!!";
	public static String DELETE_SUCCESS = "Deleted successfully!!";
	public static String EDIT_SUCCESS = "Details edited successfully!!";
	public static String ERROR_EXCEPTION = "Some error occured: ";
	public static String ERROR_EXCEPTION_CON = "An error occured: ";
	public static String UPDATE_ERROR = "Can't update now. Some error occured while updating. Please tr after sometime";
	public static String INVALID_EMAIL = "This email is not registered. Please login using registered email or create bew account to use the application";
